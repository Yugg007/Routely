...
public class RideRequest {
	...
	public String toString() {
		return "RideRequest [startAddress=" + startAddress + ", startLat=" + startLat + ", startLng=" + startLng
				+ ", endAddress=" + endAddress + ", endLat=" + endLat + ", endLng=" + endLng + ", user_id=" + user_id
				+ ", userMobNo=" + userMobNo + ", ride_id=" + ride_id + ", rideType=" + rideType + ", name=" + name
				+ ", driver_id=" + driver_id + ", driverName=" + driverName + ", driverMobNo=" + driverMobNo + "]";
	}
